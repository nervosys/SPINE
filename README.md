...
[![Tests](https://img.shields.io/badge/tests-1408%20passing-brightgreen.svg)](#testing)
...
### Test Summary (1,408 tests, 0 failures)

Latest workspace run: `cargo test --workspace --no-fail-fast` →
**1,408 passed / 0 failed / 5 ignored** across all 30 crates. The five
