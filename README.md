...
[![Tests](https://img.shields.io/badge/tests-1410%20passing-brightgreen.svg)](#testing)
...
### Test Summary (1,410 tests, 0 failures)

Latest workspace run: `cargo test --workspace --no-fail-fast` →
**1,410 passed / 0 failed / 5 ignored** across all 30 crates. The five
