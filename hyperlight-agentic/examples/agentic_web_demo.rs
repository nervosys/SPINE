...
fn main() {
    println!("╔═══════════════════════════════════════════════════════════════════════╗");
    println!("║             HYPERLIGHT AGENTIC WEB STACK DEMONSTRATION                ║");
...
fn demo_intentions_and_goals() {
    ...
    let learn_intention = agent.intend(Goal::Learn {
        ...
        depth: hyperlight_agentic::LearningDepth::Deep,
    });
...
fn demo_resource_locators() {
    ...
    // Agent-relative path
    let agent_id = hyperlight_agentic::AgentId::new();
...
fn demo_planning() {
    ...
    let step1 = plan.add_step(hyperlight_agentic::PlanStep {
        id: Uuid::new_v4(),
    ...
    let step2 = plan.add_step(hyperlight_agentic::PlanStep {
        id: Uuid::new_v4(),
    ...
    let step3 = plan.add_step(hyperlight_agentic::PlanStep {
        id: Uuid::new_v4(),
...
fn demo_knowledge_graph() {
    ...
    // Add relationships
    kg.add_edge("bert", "transformer", hyperlight_agentic::KnowledgeEdge {
    ...
    kg.add_edge("transformer", "attention", hyperlight_agentic::KnowledgeEdge {
    ...
    let messages: Vec<(&str, MessageContent)> = vec![
        ...
        ("Swarm Invite", MessageContent::SwarmInvite(SwarmTask {
            ...
            goal: Box::new(Goal::Learn {
                ...
                depth: hyperlight_agentic::LearningDepth::Expert,
            }),
            min_members: 3,
            max_members: 10,
