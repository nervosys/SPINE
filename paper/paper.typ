...
Each phase was validated against the full test suite (431 tests) with 0 regressions and 0 Clippy warnings.
...
#figure(
  ...
  caption: [Validation status by component (431 tests total)],
)
...
*25 crates. 431 tests. ~68,000 lines of Rust. A headless semantic browser for AI agents.*
